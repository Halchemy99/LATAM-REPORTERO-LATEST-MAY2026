...
export const mockWriters = [
  {
    ...
    bio: 'Award-winning investigative journalist with 15 years covering Latin American politics.',
  ...
  },
  {
    ...
    bio: 'Environmental correspondent focusing on Amazon rainforest and climate change.',
...
<li>Remittance costs reduced by 60% through blockchain rails</li>
  ...
  },
  {
    ...
    category: 'health',
    region: 'all',
    author: { name: 'AI Analysis', trustScore: 4.2, id: 'ai' },
    authorId: 'ai',
    trustScore: 4.2,
    isAiGenerated: true,
    featured: false,
