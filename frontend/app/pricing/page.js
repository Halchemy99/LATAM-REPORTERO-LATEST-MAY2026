      ...
      <main className="flex-1 flex items-center">
        <div className="container py-20">
          <div className="max-w-xl mx-auto text-center">
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-semibold text-[#1a1a1a] mb-4 leading-tight">
              {t('Membership is coming.')}
            </h1>
            <p className="text-[#666666] text-base leading-relaxed mb-8">
              {t("We're building the community before charging for it. Member calls, Signal groups, direct access to reporters across LATAM. We'll open it when it's ready, not before.")}
            </p>
            <p className="text-sm text-[#666666] mb-10">
              {t('In the meantime, the newsletter is free. Always. No account, no card, no catch.')}
            </p>
