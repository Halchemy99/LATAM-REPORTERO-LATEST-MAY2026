          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Data we collect and why</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Data we will never ask for or collect</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Control over your data (GDPR-compliant)</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {userRights.map((right) => (
                    <div key={right.right} className="p-4 border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="font-medium">Right to {right.right}</p>
                      </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Services that process your data</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  We only use services that meet our security standards. We never sell your data to anyone.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-purple-50 border-purple-200">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">Questions About Your Data?</h3>
