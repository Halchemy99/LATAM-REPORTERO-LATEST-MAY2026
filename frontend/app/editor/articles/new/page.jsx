...
export default function NewArticlePage() {
  ...
  const handleSave = async (status = 'draft') => {
    try {
      ...
      router.push(`/editor/articles/${newArticle.id}`);
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container py-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">Please log in to create articles.</p>
          <Button asChild>
        ...
        <div className="container py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="font-semibold" style={{ fontFamily: 'Raleway, sans-serif' }}>
                New Article
              </h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                disabled={saving || !article.title_en}
              >
