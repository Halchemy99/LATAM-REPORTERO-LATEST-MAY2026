    ...
    <div className="bg-[#1a1a1a] p-4 mb-6" data-testid="podcast-player">
      ...
      <div className="flex items-center gap-3 mt-3">
        <Button
          ...
          className="h-9 w-9 rounded-full bg-[#6111ff] hover:bg-[#4a0dd6] text-white flex-shrink-0"
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            <div className="h-full bg-[#6111ff] transition-all duration-200" style={{ width: `${progress}%` }} />
          </div>
